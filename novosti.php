...
$query = "SELECT id, naziv_datoteke, link FROM upute";
$result = $pdo->query($query);
$upute = $result->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <table class="ticket-container">
        ...
        <tbody>
            ...
            <tr>
                <td><a href="<?php echo htmlspecialchars($uputa['link']); ?>" target="_blank"><?php echo htmlspecialchars($uputa['naziv_datoteke']); ?></a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
